...
4. Updates json_formatter_summary_ground_truth.json
...
GROUND_TRUTH_FILE = OUTPUT_DIR / "json_formatter_summary_ground_truth.json"
...
def main():
    ...
    if GROUND_TRUTH_FILE.exists():
        ...
        print(f"\nCreating new ground truth file: {GROUND_TRUTH_FILE}")
        ground_truth = {
            "_meta": {
                "extension": "JSON Formatter",
                "verification_status": "network_messaging_storage_complete"
            }
        }
